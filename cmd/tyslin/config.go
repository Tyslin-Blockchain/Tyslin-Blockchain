...
func loadConfig(file string, cfg *tyslinConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "tyslin.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, tyslinConfig) {
	// Load defaults.
	cfg := tyslinConfig{
	...
	if ctx.GlobalBool(utils.TyslinTestnetFlag.Name) {
...
func makeFullNode(ctx *cli.Context) (*node.Node, tyslinConfig) {
