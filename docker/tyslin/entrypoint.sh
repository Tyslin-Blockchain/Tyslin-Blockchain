...
if [[ ! -z $NETWORK_ID ]]; then
  case $NETWORK_ID in
    ...
    89 )
      ...
      params="$params --tyslin-testnet --gcmode archive --rpcapi db,eth,net,web3,personal,debug"
      ;;
    90 )
...
# data dir
if [[ ! -d $DATA_DIR/tyslin ]]; then
  echo "No blockchain data, creating genesis block."
  tyslin init $genesisPath --datadir $DATA_DIR 2> /dev/null
fi
